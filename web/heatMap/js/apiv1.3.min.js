(function () {
    ...
    a2.dom.getPosition = function (T) {
        T = a2.dom.g(T);
        var cM = a2.dom.getDocument(T), cG = a2.browser, cJ = a2.dom.getStyle, cF = cG.isGecko > 0 && cM.getBoxObjectFor && cJ(T, "position") == "absolute" && (T.style.top === "" || T.style.left === ""), cK = {
            left: 0,
            top: 0
        }, cI = (cG.ie && !cG.isStrict) ? cM.body : cM.documentElement, cN, cE;
        if (T == cI) {
            return cK
        }
    ...
    a2.lang.Event.prototype.inherit = function (cF) {
        ...
        if (cF.touches) {
            ...
            for (var T = 0; T < cF.touches.length; T++) {
                cE.touches.push({
                    clientX: cF.touches[T].clientX,
                    clientY: cF.touches[T].clientY,
                    screenX: cF.touches[T].screenX,
                    screenY: cF.touches[T].screenY,
                    pageX: cF.touches[T].pageX,
                    pageY: cF.touches[T].pageY,
                    target: cF.touches[T].target,
                    identifier: cF.touches[T].identifier
                })
            }
        }
        if (cF.changedTouches) {
            ...
            for (var T = 0; T < cF.changedTouches.length; T++) {
                cE.changedTouches.push({
                    clientX: cF.changedTouches[T].clientX,
                    clientY: cF.changedTouches[T].clientY,
                    screenX: cF.changedTouches[T].screenX,
                    screenY: cF.changedTouches[T].screenY,
                    pageX: cF.changedTouches[T].pageX,
                    pageY: cF.changedTouches[T].pageY,
                    target: cF.changedTouches[T].target,
                    identifier: cF.changedTouches[T].identifier
                })
            }
        }
        if (cF.targetTouches) {
            ...
            for (var T = 0; T < cF.targetTouches.length; T++) {
                cE.targetTouches.push({
                    clientX: cF.targetTouches[T].clientX,
                    clientY: cF.targetTouches[T].clientY,
                    screenX: cF.targetTouches[T].screenX,
                    screenY: cF.targetTouches[T].screenY,
                    pageX: cF.targetTouches[T].pageX,
                    pageY: cF.targetTouches[T].pageY,
                    target: cF.targetTouches[T].target,
                    identifier: cF.targetTouches[T].identifier
                })
            }
        }
    ...
    function bt(cG, cI) {
        ...
        cH.config = {
            ...
            zoomerDuration: 240,
            actionDuration: 450,
            defaultCursor: b5.defaultCursor,
            draggingCursor: b5.draggingCursor,
            isOverviewMap: false,
            minZoom: 1,
            maxZoom: 18,
    ...
    a2.extend(bt.prototype, {
        render: function () {
            ...
            var cE = arguments[0] || {}, cG = cE.margins || [0, 0, 0, 0], T = cE.zoom || null, cH = this.pixelToPoint({
                x: cG[3],
                y: this.height - cG[2]
            }, T), cF = this.pixelToPoint({x: this.width - cG[1], y: cG[0]}, T);
            return new bG(cH, cF)
        }, isLoaded: function () {
            return !!this.loaded
    ...
    function g(cG) {
        var T = {
            duration: 1000, fps: 30, delay: 0, transition: ar.linear, onStop: function () {
            }
        };
        this._anis = [];
        if (cG) {
    ...
    var b5 = {
        imgPath: "/heatMap/images/",
        cityNames: {"\u5317\u4eac": "bj", "\u4e0a\u6d77": "sh", "\u6df1\u5733": "sz", "\u5e7f\u5dde": "gz"},
        fontFamily: "arial,sans-serif"
    };
    if (a2.browser.firefox) {
        a2.extend(b5, {
            distCursor: "url(" + b5.imgPath + "ruler.cur),crosshair",
        ...
        if (a2.browser.chrome || a2.browser.safari) {
            a2.extend(b5, {
                distCursor: "url(" + b5.imgPath + "ruler.cur) 2 6,crosshair",
                defaultCursor: "url(" + b5.imgPath + "openhand.cur) 8 8,default",
                draggingCursor: "url(" + b5.imgPath + "closedhand.cur) 8 8,move"
            })
        } else {
            a2.extend(b5, {
                distCursor: "url(" + b5.imgPath + "ruler.cur),crosshair",
                defaultCursor: "url(" + b5.imgPath + "openhand.cur),default",
                draggingCursor: "url(" + b5.imgPath + "closedhand.cur),move"
            })
        }
    }
    function aq(cF, cE, T) {
    ...
    a2.object.extend(ct, {
        ...
        preLoaded: {},
        Config: {_baseUrl: "/heatMap/js/", _timeout: 5000},
        delayFlag: false,
    ...
    function cD(T) {
        ...
        T = T || {};
        this._opts = {printable: false};
        this._opts = a2.extend(a2.extend(this._opts, {
            size: new aC(150, 150),
            padding: 5,
            isOpen: false,
            zoomInterval: 4
    ...
    a2.object.extend(cs.prototype, {
        initialize: function (cE, T) {
            this._map = cE;
    ...
    a2.object.extend(a8.prototype, {
        initialize: function (T, cE) {
            this._map = T;
    ...
    cx.prototype = new a4();
    a2.extend(cx.prototype, {
        lngLatToMercator: function (cE, T) {
    ...
    var ap = new K(b5.imgPath + "marker_red_sprite.png", new aC(19, 25), {
        anchor: new aC(10, 25),
        infoWindowAnchor: new aC(10, 0)
    });
    var an = new K(b5.imgPath + "marker_red_sprite.png", new aC(20, 11), {
        anchor: new aC(6, 11),
        imageOffset: new aC(-19, -13)
    });
    ...
    a2.extend(cg.prototype, {
        setPath: function (cE, T) {
    ...
    function bN(cK, T, cH, cE, cG) {
        ...
        this.img.onload = function (cR) {
            ...
            if (C) {
                new g({
                    fps: 20, duration: 200, render: function (cS) {
    ...
    a2.extend(n.prototype, {
        initialize: function (cF, T) {
            if (this.baseLayer) {
                this.zIndex = -100
            }
            this.map = cF;
    ...
    aO.getTilesUrl = function (cF, cI) {
        ...
        cE = "/heatMap/maptile/" + cI + "/" + cJ + "/" + cG + ".jpg";
        ;
    ...
    window.BMAP_PERSPECTIVE_MAP = new cn("\u4e09\u7ef4", bm, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
        minZoom: 15,
        maxZoom: 20,
        textColor: "white",
    ...
    window.BMAP_SATELLITE_MAP = new cn("\u536b\u661f", bJ, {
        tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
        minZoom: 1,
        maxZoom: 19,
        textColor: "white"
    ...
    window.BMAP_HYBRID_MAP = new cn("\u6df7\u5408", [bJ, m], {
        tips: "\u663e\u793a\u5e26\u6709\u8857\u9053\u7684\u536b\u661f\u5f71\u50cf",
        labelText: "\u8def\u7f51",
        minZoom: 1,
        maxZoom: 19,
    ...
    function u(cE, T) {
        ...
        this.setLocation(cE);
        this._opts = {
            renderOptions: {panel: null, map: null, autoViewport: true}, onSearchComplete: function () {
    ...
    var a5 = {
        REQ_BASE_URL: "http://api.map.baidu.com/", request: function (cE, cK, T, cJ) {
    ...
    a2.extend(aS.prototype, {
        getPoint: function (T, cF, cE) {
    ...
    a2.extend(ah.prototype, {
        getCurrentPosition: function (cE, T) {
    ...
    function bs(cE) {
        ...
        cE = cE || {};
        this._options = {
            input: null, types: [], onSearchComplete: function () {
            }
        };
