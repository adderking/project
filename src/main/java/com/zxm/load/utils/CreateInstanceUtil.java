...
//        if("南向北".equals(direction)) {
//            direction = DirectionEnum.SOUTH_TO_NORTH.name();
//        } else if("北向南".equals(direction)) {
//            direction = DirectionEnum.NORTH_TO_SOUTH.name();
//        } else if("东向西".equals(direction)) {
//            direction = DirectionEnum.EAST_TO_WEST.name();
//        } else if("西向东".equals(direction)) {
//            direction = DirectionEnum.WEST_TO_EAST.name();
//        }
